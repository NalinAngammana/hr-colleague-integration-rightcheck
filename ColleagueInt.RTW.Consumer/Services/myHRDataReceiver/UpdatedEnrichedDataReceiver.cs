...
{
    public class UpdatedEnrichedDataReceiver : BaseEnrichedDataReceiver
    {

        public UpdatedEnrichedDataReceiver(
                                ILogger<UpdatedEnrichedDataReceiver> logger, IServiceProvider serviceProvider,
